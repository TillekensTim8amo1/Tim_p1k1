...
if(isset($_POST['kalenderUit'])){
    $sql = "DELETE TABLE kalender";}
?>
...
<h2>kalender module beheer</h2>
	<div class="formelier">
		...
		<label>Naam database</label><br>
			...
			<input type="checkbox" name="kalender" value="1" class="form-check-input">
			<label>kalender module aan</label>

			<input type="checkbox" name="kalenderUit" value="1" class="form-check-input">
			<label>kalender module uit</label>
		<div class="knop">
