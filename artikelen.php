...
if(isset($_POST['artikelenUit'])){
    $sql = "DELETE TABLE artikelen";}
?>
...
<h2>artikelen module beheer</h2>
	<div class="formelier">
		...
		<label>Naam database</label><br>
			...
			<input type="checkbox" name="artikelen" value="1" class="form-check-input">
			<label>artikelen module aan</label>

			<input type="checkbox" name="artikelenUit" value="1" class="form-check-input">
			<label>artikelen module uit</label>
		<div class="knop">
