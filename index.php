...
<!-- hier staat code om de pagina te stylen -->
<style type="text/css">
	a {
...
<body>
	...
	<div class="formelier">
    	...
    	<!-- Hier staan de linkjes naar de paginas waar je tabllen in de database kaan aan/uitzetten -->
    	<div class="knop">
        <button name="subrit" class="knopjes"><a href="subrit.php"> Subrit beheer</a></button>
        <button name="boekhoud" class="knopjes"><a href="boekhoud.php">boekhoud beheer</a></button>
        <button name="kalender" class="knopjes"><a href="kalender.php">kalender beheer</a></button>
        <button name="artikel" class="knopjes"><a href="artikelen.php">Artikelen beheer</a></button><br>
        <button name="loguit" class="knopjes1">log uit</button>
    	</div>
		</form>
	</div>
</body>
